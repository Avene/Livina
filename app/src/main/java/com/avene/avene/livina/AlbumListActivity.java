 ...
 * {@link AlbumListFragment} and the item details
 * (if present) is a {@link AlbumDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link AlbumListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class AlbumListActivity extends FragmentActivity
        implements AlbumListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.album_detail_container) != null) {
            ...
            ((AlbumListFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.album_list))
    ...
    /**
     * Callback method from {@link AlbumListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(AlbumDetailFragment.ARG_ITEM_ID, id);
